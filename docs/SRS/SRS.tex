...
\subsubsection{Centralized Domain Data Location}\label{goal-central-data}
...
\subsubsection{Automated Data Collection}\label{goal-auto-data}
...
\subsubsection{Interactive Data Table}\label{goal-data-table}
...
\subsubsection{Automated Analytic Hierarchy Process}\label{goal-auto-ahp}
...
\subsubsection{Data Visualization and Download}\label{goal-visual}
...
\subsubsection{Collaboration and Access Control}\label{goal-collab}
