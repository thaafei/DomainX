...
We use both \href{https://docs.pytest.org/en/stable/}{pytest} and \href{https://jestjs.io/}{jest} to implement automatic unit tests for both the frontend and backend of the system. 
