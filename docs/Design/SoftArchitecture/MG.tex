...
\item[Services:] Facilitates the process of processing a inputted file into data for use by the rest of the system. Contains the external libraries and additional mechanisms to retrieve and format inputted files.
