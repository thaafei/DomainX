...
For example, FR5 "Admin can create domains, using a unique domain name and optionally a short description.", the modules needed to fulfill the requirement is \mref{mDomainsPage} and \mref{mUserMgm}. 
