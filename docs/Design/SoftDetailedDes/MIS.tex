...
\subsubsection{Module}
Authenticates users and manages session tokens. Supports login/logout, session validation, and invitation-based account creation (admin-issued invites with verification codes).
