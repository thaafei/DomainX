...
This software and associated documentation files for this project are protected by copyright as dictated by the \href{https://github.com/thaafei/DomainX/blob/main/LICENSE}{MIT License}.
...
\subsection{Team Meetings}
  ...
  \begin{enumerate}
    ...
    \item Each member has the opportunity to bring up any blockers, concerns, or issues they are facing
...
\subsection{Supervisor and Domain Expert Meetings}
  Weekly supervisors meetings are held every \textbf{Thursday 2:30-3:30pm in-person}, unless otherwise stated.
...
\begin{itemize}
  \item \textbf{Discord:} Main way of communication between team members.
  \item \textbf{Microsoft Teams:} Secondary way of communication between team members, used for online meetings.
  ...
  \item \textbf{Email:} Communication with the supervisor and domain expert, with all team members cc-ed.
\end{itemize}
\section{Team Member Roles}
\begin{itemize}
  \item \textbf{DevOps Lead:} Responsible for maintaining the GitHub repository to properly track the development process. Updating and maintaining the GitHub Project Board, and ensuring issues are properly assigned the correct milestone and project.
  \item \textbf{Team Leader:} Oversees the overall process of the whole project. Ensures both subteam are on track. Creates and assigns issues, delegates work. Coordinates meetings between team members and all stakeholders.
  ...
  \item \textbf{Meeting Chair:} Chair for meetings involving stakeholders. Responsible for creating the agenda before each meeting, leading the meeting and guiding discussion topics.
  \item \textbf{Peer Reviewer:} Reviews artifacts for other team and provides feedback. 
\end{itemize}
\begin{center}
\begin{tabular}{|l|l|}
\hline
...
We will use \href{https://github.com/thaafei/DomainX/issues}{GitHub Issues} to organize both meeting notes and project development tasks.
...
\href{https://github.com/thaafei/DomainX/milestone/1}{Problem Statement, POC and Dev Plan} & Week 04 \\
\href{https://github.com/thaafei/DomainX/milestone/2}{SRS + HA Revision 0} & Week 06 \\
\href{https://github.com/thaafei/DomainX/milestone/3}{V\&V Plan Revision 0} & Week 08 \\
\href{https://github.com/thaafei/DomainX/milestone/13}{Design Document Revision -1} & Week 10 \\
\href{https://github.com/thaafei/DomainX/milestone/5}{Proof of Concept Demonstration} & Week 11--12 \\
\href{https://github.com/thaafei/DomainX/milestone/12}{Proof of Concept Team Contribution} & Week 11--12 \\
\href{https://github.com/thaafei/DomainX/milestone/6}{Design Document Revision 0} & Week 16 \\
\href{https://github.com/thaafei/DomainX/milestone/7}{Revision 0 Demonstration} & Week 18--19 \\
\href{https://github.com/thaafei/DomainX/milestone/8}{V\&V Report Revision 0} & Week 22 \\
\href{https://github.com/thaafei/DomainX/milestone/9}{Final Demonstration Revision 1} & Week 24 \\
\href{https://github.com/thaafei/DomainX/milestone/10}{EXPO Demonstration} & Week 26 \\
\href{https://github.com/thaafei/DomainX/milestone/11}{Final Documentation Revision 1} & Week 26 \\
\hline
\end{tabular}
\end{center}
...
\subsection*{Data Access \& API Limitations}\vspace{-0.5em}
...
\\\textbf{Addressing the risk:}\\
We will demonstrate that parsed data can be stored in a suitable schema. If we find during the PoC that the relational database struggles with large datasets or that the schema design limits flexibility, we will consider exploring a NoSQL option such as MongoDB as a backup to reduce these risks.

\subsection*{Visualization \& Graphing}\vspace{-0.5em}
...
\\\textbf{Addressing the risk:}\\
We will show that simple visualizations and graphs can be created using mock data during the demonstration. 

\subsection*{Integration Risk}\vspace{-0.5em}
...
\\\textbf{Addressing the risk:}\\
Our proof of concept will focus on showing that the main components of the system can work together in practice. \\\\

\section{Expected Technology}

Our project will be a web-based application with a \href{https://react.dev/}{React} frontend to handle interaction and show graphs, \href{https://www.djangoproject.com/}{Django} backend to process data and manage requests, and a \href{https://www.mysql.com/}{MySQL} database to store the results. We plan to explore deploying the application on a cloud platform such as \href{https://aws.amazon.com/}{Amazon Web Services (AWS)} or \href{https://cloud.google.com/}{Google Cloud} later in the project to make collaboration and access easier for the team and supervisors.\\ \\
We plan to use \href{https://pypi.org/project/requests/}{Requests} for making API calls and \href{https://pypi.org/project/pandas/}{Pandas} to organize and clean the data before saving it on the backend. \href{https://pypi.org/project/numpy/}{NumPy} might also be used for simple calculations. On the frontend, we expect to use a library like \href{https://www.chartjs.org/}{Chart.js} to build the graphs and comparisons.\\ \\
We will use \href{https://git-scm.com/}{Git} and \href{https://github.com/thaafei/DomainX}{GitHub} for version control. Our workflow will be based on creating \href{https://github.com/thaafei/DomainX/issues}{GitHub Issues} for tasks, linking the related work to those issues, and developing each feature or fix on a separate branch. Once the work is ready, it will be merged into the main codebase through a pull request. We will also use \href{https://github.com/users/thaafei/projects/6}{GitHub Projects} to track tasks and progress.\\ \\
...
To help automate adherence to \href{https://peps.python.org/pep-0008/}{PEP 8} and maintain high code quality, we will use the following tools:
\begin{itemize}
  \item \textbf{\href{https://github.com/psf/black}{Black}} – an automatic code formatter to ensure consistent style across all files.
  \item \textbf{\href{https://pycqa.github.io/isort/}{isort}} – to automatically sort and organize import statements.
  \item \textbf{\href{https://flake8.pycqa.org/en/latest/}{Flake8}} – a lightweight linter for detecting syntax errors and style violations.
  \item \textbf{\href{https://pypi.org/project/pylint/}{Pylint}} – a feature-rich linter for deeper static analysis and code quality checks.
\end{itemize}

On the frontend, we’ll use \href{https://react.dev/}{React} with \href{https://www.typescriptlang.org/}{TypeScript}. For this, we’ll rely on the \href{https://react-typescript-cheatsheet.netlify.app/}{React TypeScript Cheatsheet} for common patterns and Google’s \href{https://google.github.io/styleguide/tsguide.html}{TypeScript Style Guide}.
...
Our team expects full commitment to all scheduled meetings, with everyone arriving on time and staying for the entire duration. It is up to the responsibility of the individual to identify if they cannot make a meeting, and inform the team beforehand.
