...
\begin{itemize}
  \item A curated shortlist of $N=28$ open-source NN software packages evaluated using a consistent, evidence-based procedure (Appendix~\ref{app-packages}).
...
%  Point to Appendix~\ref{app-packages} for the full list and exclusions (see emails).}
 ...
 were removed. Following supervisor guidance, NN software packages were retained even when they appeared only once across the
  authoritative sources to prioritize completeness of coverage. The final shortlist contains $N=28$ packages. 
