...
class Domain(models.Model):
    ...
    category_weights = models.JSONField(default=dict, blank=True, null=True)
    creators = models.ManyToManyField(
        settings.AUTH_USER_MODEL, related_name="created_domains", blank=True
    )
    ...
    ahp_matrix = models.JSONField(default=dict, blank=True, null=True)
