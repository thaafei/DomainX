...
const UserProfilePage: React.FC = () => {
  ...
  const getInputBorder = (type: "current" | "new" | "confirm") => {
    if (type === "confirm" && passwordData.confirm_password.length > 0 && passwordData.new_password !== passwordData.confirm_password) {
      return "2px solid #ff4d4f";
    }
    if (type === "new" && passwordData.new_password.length > 0 && !passwordValid) {
      return "2px solid #ff4d4f";
    }
    return undefined;
  };
  ...
  const isPasswordFormValid =
    allFieldsFilled && passwordData.new_password === passwordData.confirm_password && passwordValid;
          ...
          <div className="dx-card" style={{ padding: "40px", border: "1px solid rgba(255,255,255,0.05)" }}>
            ...
            {activeTab === "details" ? (
              ...
              <form
                ...
                style={{ maxWidth: "450px", display: "flex", flexDirection: "column", gap: "24px" }}
              >
                <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                  ...
                  <input
                    className="dx-input"
                    type="password"
                    style={{ border: getInputBorder("new"), transition: "border-color 0.2s ease" }}
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                  ...
                  {passwordData.confirm_password && !passwordsMatch && (
                    <span style={{ color: "#ff4d4f", fontSize: "0.75rem" }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: "12px 32px",
                    marginTop: "8px",
                    opacity: isPasswordFormValid ? 1 : 0.5,
                    cursor: isPasswordFormValid ? "pointer" : "not-allowed",
                  }}
                >
              ...
              {allDomains.map((domain) => (
                <label
                  ...
                  style={{
                    ...
                    padding: "10px 15px",
                    borderRadius: "6px",
                    background: formData.domain_ids.includes(String(domain.domain_ID))
                      ? "rgba(79, 172, 254, 0.1)"
